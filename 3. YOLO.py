...
# Define paths
data_folder = r"C:\Users\vrunda\Desktop\yolo\val2017"  # Directory containing image files
json_file = r"C:\Users\vrunda\Desktop\yolo\instances_val2017.json"  # Path to COCO JSON file
output_directory = r"C:\Users\vrunda\Desktop\yolo\dataset_yolo"  # Directory for YOLO dataset output
...
# to train
# python train.py --img 640 --batch 8 --epochs 10 --data C:\Users\vrunda\Desktop\yolo\dataset_yolo\data.yaml --weights yolov5s.pt --name outputtt
# to detect
# python detect.py --weights C:\Users\vrunda\Desktop\yolo\yolov5\runs\train\outputtt\weights\best.pt --img 640 --conf 0.25 --source C:\Users\vrunda\Desktop\yolo\dataset_yolo\test\images\000000008021.jpg
